...
ML64.EXE /c /nologo /Fo"CreateJavaVM_x64.obj"         "CreateJavaVM_x64.asm"
ML64.EXE /c /nologo /Fo"Native_RaiseCallback_x64.obj" "Native_RaiseCallback_x64.asm"
IF NOT %ERRORLEVEL% == 0 goto bad_compile

ECHO Coverting to INL...
..\..\..\MiscUtils\File2Inc\File2Inc.exe CreateJavaVM_x64.obj         CreateJavaVM_x64.inl         /var:aCreateJavaVMX64        /type:obj
..\..\..\MiscUtils\File2Inc\File2Inc.exe Native_RaiseCallback_x64.obj Native_RaiseCallback_x64.inl /var:aNativeRaiseCallbackX64 /type:obj
GOTO end
