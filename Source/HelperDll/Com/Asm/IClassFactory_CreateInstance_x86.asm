...
INIT:
    push    ebp
    mov     ebp, esp
    mov     eax, DWORD PTR [ebp+14h] ;ppvObject
    push    eax
    mov     eax, DWORD PTR [ebp+10h] ;riid
    push    eax
    ...
    push    eax
    mov     eax, 0DEAD0002h          ;address of MyIClassFactory_CreateInstance/IClassFactory2_CreateInstance
    call    eax
    pop     ebp
    ret     10h
